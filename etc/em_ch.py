...
#    shape=\ *(1, batch_size)*
# -  ``last_hidden``: final hidden layer of GRU; shape=\ *(num_layers x
#    num_directions, batch_size, hidden_size)*
...
# -  ``hidden``: final hidden state of GRU; shape=\ *(num_layers x
#    num_directions, batch_size, hidden_size)*
#
...
# print("Vocab size : ", len(voc.index2word.values()))
#
