...
encoder = EncoderRNN(hidden_size, embedding, encoder_num_layers, dropout, batch_size)
# decoder = LuongAttnDecoderRNN(attn_model, embedding, hidden_size, vocab_size, decoder_num_layers, dropout)
decoder = PlainDecoder(attn_model, embedding, hidden_size, vocab_size, batch_size, decoder_num_layers)
...
batch_size = 1
# Forward
forward_encoder = EncoderRNN(hidden_size, embedding, encoder_num_layers, dropout, batch_size)
forward_decoder = PlainDecoder(attn_model, embedding, hidden_size, vocab_size, batch_size, decoder_num_layers, dropout)

# Backward
backward_encoder = EncoderRNN(hidden_size, embedding, encoder_num_layers, dropout, batch_size)
backward_decoder = PlainDecoder(attn_model, embedding, hidden_size, vocab_size, batch_size, decoder_num_layers, dropout)
